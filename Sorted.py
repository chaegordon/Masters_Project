...
theta_df = pd.DataFrame([0,61,45,73,30,20], columns =['Angle of Incidence/ degrees'])

h_t_df = theta_df.join(h_df)

h_t_df = h_t_df.sort_values('Angle of Incidence/ degrees', )

yerr = np.sort([0.3,0.3,0.5,0,0.7,0.44])
...
fig.savefig('h_50_versus_theta_sorted.pdf')
